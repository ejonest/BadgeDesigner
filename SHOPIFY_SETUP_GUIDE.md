...
3. Try designing a badge
4. Test the "Add to Cart" button

## Step 5: What Information I Need
...
- Step 2: Setting up Gadget webhooks to detect orders
- Step 3: Automatically saving orders to Supabase with all badge data
