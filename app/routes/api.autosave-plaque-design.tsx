...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    const saved = await upsertPlaqueAutosaveDesign(row);
    ...
    console.error("[PlaqueDesigner] api.autosave-plaque-design error:", error);
    const details =
