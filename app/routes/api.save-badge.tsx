...
import { parseOr400, saveBadgeBodySchema } from "~/utils/validation";

const GADGET_APP_URL =
...
export const action: ActionFunction = async ({ request }) => {
  console.log(
    "[BadgeDesigner] api.save-badge request received",
  ...
  try {
    ...
    console.log(
      "Debug - gadgetPayload.textLines type:",
      typeof gadgetPayload.textLines,
    );
    console.log(
      "Debug - Full gadgetPayload:",
      JSON.stringify(gadgetPayload, null, 2),
    );

    console.log(
      "Attempting to create badge design with payload:",
      gadgetPayload,
    );
