...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    const saved = await upsertDeskSignAutosaveDesign(row);
    ...
    console.error("[DeskSignDesigner] api.autosave-desk-sign-design error:", error);
    const details =
