...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/badgeDesigns", {
      method: "GET",
      headers: {
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/badge-designs", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/graphql", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/public/badgeDesigns", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/badgeDesign", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    ...
    const response = await fetch("https://all-quality-badge-designer--development.gadget.app/api/rest/badgeDesigns", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
