 ...
 * Handles gavel, pen, trophy, and plaque cart lines on the same order,
 * because the store registers a single `orders/paid` webhook.
 *
...
export async function action({ request }: ActionFunctionArgs) {
  return handleNativeShopifyOrderPaid({
    ...
    allowed: ["gavel", "pen", "trophy", "plaque"],
  });
}
