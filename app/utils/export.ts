...
export type SvgBlobExportOptions = {
  /**
   * @deprecated No longer reduces SVG quality. Kept so call sites compile;
   * storage SVGs always embed fonts and inline images like local export.
   */
